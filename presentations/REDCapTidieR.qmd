...
::: columns
::: {.column width="50%"}
![](images/REDCapTidieR/whoami.png)
:::
...
::: {.column width="50%"}
::: {.r-stack}
Front-End Data Entry UI ![](images/REDCapTidieR/superpower_repeat_1.png){.fragment}
![](images/REDCapTidieR/superpower_repeat_2.png){.fragment}
:::
:::
:::
